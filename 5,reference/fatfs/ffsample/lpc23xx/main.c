...
const char HelpMsg[] =
	...
	" dcs <pd#> - Issure CTRL_SYNC command\n"
	" dce <pd#> <s.lba> <e.lba> - Issue CTRL_ERASE_SECTOR command\n"
	" dcf <pd#> - Issure NAND_FORMAT command\n"
	"[Buffer controls]\n"
	...
	"[Misc commands]\n"
	" FD - Launch filer\n"
	" FL <file> - Launch file loader (bmp, jpg, img or txt)\n"
